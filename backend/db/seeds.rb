...
Question.create(game_id: 3, content: "Agatha Harkness claims that Scarlet Witch's twin boys are shards from whose soul?", correct_answer: "Mephisto", option_a: "Magneto", option_b: "Mepisto", option_c: "Death", option_d: "Doctor Doom")
